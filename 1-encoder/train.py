...
# ダミーデータの作成
train_data = [
    {'comment': 'This is a hack, need to fix in future', 'label': 1},
    {'comment': 'Calculate the area','label': 0},
    # 他のデータも同様に
]

valid_data = [
    {'comment': 'Temporary solution','label': 1},
    {'comment': 'Calculate the volume','label': 0},
    # 他のデータも同様に
]
